...
for i=1:length(pictureDataFixed)
    [hist_mat, hist_vec] = histogram(pictureDataFixed{i,1}, pictureDataFixed{i,3}, binSize, @pixelNorm);
...
for i=1:length(synthPicsData)
    [hist_mat, hist_vec] = histogram(synthPicsData{i,1}, synthPicsData{i,3}, binSize, @pixelNorm);
...
save(sprintf('dataPixelnb.mat'),'train_x','train_t','-v7.3');
